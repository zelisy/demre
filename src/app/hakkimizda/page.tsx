  ...
  return (
    <>
      ...
      <section className="relative flex flex-col items-center justify-center min-h-[60vh] px-4 overflow-hidden" style={{ zIndex: 1, paddingTop: 0, marginTop: 0 }}>
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 w-full bg-white/10 border-2 border-primary/60 rounded-xl shadow-lg backdrop-blur-sm py-8 max-w-2xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-primary to-secondary rounded-lg p-6 shadow-inner w-full max-w-xl">
            <h2 className="text-2xl font-semibold text-primary mb-2 font-sans">Misyonumuz</h2>
