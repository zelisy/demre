export default function Header() {
  return (
    <header className="w-full h-20 bg-gradient-to-r from-teal-400 to-green-500 text-white shadow-lg border-b border-teal-500/40">
      <div className="flex justify-between items-center h-full px-4 md:px-10">
        ...
        <nav className="flex space-x-4 md:space-x-8 text-base md:text-lg font-semibold uppercase tracking-wider">
          ...
          <a href="/hakkimizda" className="hover:text-green-300 hover:underline underline-offset-4 transition">Hakkımızda</a>
